  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#d4ae2a]/5 rounded-full blur-[150px]" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[#d4ae2a] text-sm font-medium uppercase tracking-[0.15em]">Headquarters Operations</p>
        </div>
        ...
        <div className="bg-[#111111] border border-[#1f1f1f] rounded-3xl p-8 shadow-2xl shadow-black/50">
          ...
          <p className="text-[#555] text-sm mb-7">Enter your credentials to access the dashboard</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@cherubim.com"
                />
              </div>
            </div>
